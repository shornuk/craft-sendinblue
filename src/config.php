...
/**
 * SendinBlue config.php
 *
 * This file exists only as a template for the SendinBlue settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'sendin-blue.php'
